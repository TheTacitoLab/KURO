...
export default function BriefPage() {
  return (
    <section
      className="bg-void text-white relative tex-grain min-h-screen pt-32 md:pt-40 pb-24 md:pb-32"
      aria-labelledby="brief-heading"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-20 right-0 w-[520px] h-[520px] rounded-full bg-flare/60 blur-3xl"
      />
      <div
        aria-hidden="true"
        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="md:col-span-5 md:sticky md:top-32 md:self-start">
            ...
            <AnimatedReveal delay={0.16}>
              <p className="type-lede text-ash mt-6">
                One short form. Reply within two working days.
              </p>
            </AnimatedReveal>

            <AnimatedReveal delay={0.22}>
              <div className="mt-10 bg-slate border border-line rounded-2xl p-6">
            ...
            <AnimatedReveal delay={0.28}>
              <div className="mt-6 space-y-2">
                <a
                  ...
                  className="type-body text-white hover:text-coral transition-colors block"
                >
                  hello@deptkuro.com
                </a>
                <a
                  ...
                  className="type-body text-ash hover:text-white transition-colors block"
                >
                  @deptkuro
                </a>
              </div>
